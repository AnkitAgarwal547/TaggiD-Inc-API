...
class TaggUser(AbstractUser):
    ...
    tier_icon = models.ImageField(max_length=250, upload_to='mediafiles/', null=True)
    color =  models.CharField(max_length=30, null=True, blank=True)
    image_background = models.ImageField(max_length=250, upload_to='mediafiles/', null=True)
